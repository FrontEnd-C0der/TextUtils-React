...
export default function TextForm(props) {
    ...
    return (
        <>
            <div className="container" style={{ color: props.mode === 'dark' ? 'white' : '#010b13' }}>
                <h1 className='mb-4'>{props.heading}</h1>
                <div className="mb-3">
                    <textarea className="form-control" value={text} onChange={handleOnChange} style={{ background: props.mode === 'dark' ? '#010b13' : 'white', color: props.mode === 'dark' ? 'white' : '#010b13' }} id="myBox" rows="8"></textarea>
                </div>
                ...
                <button disabled={text.length === 0} className="btn btn-success mx-1 my-1" onClick={handleExtraSpaces}>Remove Extra Space</button>
